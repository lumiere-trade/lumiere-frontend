...
export function StrategyPanel({ isOpen, onToggle }: StrategyPanelProps) {
  ...
  if (!isOpen) {
    return (
      <div className="w-8 bg-card border-r border-primary/20 flex items-center justify-center">
        <button
          onClick={onToggle}
  ...
  return (
    <div className="w-[300px] bg-background border-r border-primary/20 flex flex-col overflow-hidden">
      {/* Scrollable Sections */}
