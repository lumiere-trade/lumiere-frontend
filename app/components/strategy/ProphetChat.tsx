...
export function ProphetChat({ onStrategyGenerated, isExpanded, onExpand, onCollapse }: ProphetChatProps) {
  const log = useLogger('ProphetChat', LogCategory.COMPONENT)
