        ...
        if (ruleLower.includes('macd') && ruleLower.includes('crosses')) {
          ...
          return (
            <div key={idx} className="space-y-2">
              <div className="text-sm font-mono text-muted-foreground">{rule}</div>
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                {crossesAbove ? (
                  ...
                  <>
                    ...
                    <text x="10" y="80" fill="currentColor" opacity="0.5" fontSize="12" fontWeight="600">Signal</text>
                  </>
                )}
        ...
        if ((ruleLower.includes('ema') || ruleLower.includes('sma')) && ruleLower.includes('crosses')) {
          ...
          return (
            <div key={idx} className="space-y-2">
              <div className="text-sm font-mono text-muted-foreground">{rule}</div>
              <svg viewBox="0 0 400 120" className="w-full h-32">
                <path d="M 0 70 Q 100 68 200 70 Q 300 72 400 70" stroke="#f97316" strokeWidth="2" fill="none" opacity="0.7" />
                <path d={crossesAbove ? 
                        "M 0 85 Q 100 78 200 65 Q 300 58 400 55" : 
                        "M 0 55 Q 100 62 200 75 Q 300 82 400 85"} 
        ...
        if ((ruleLower.includes('close') || ruleLower.includes('price')) && (ruleLower.includes('ema') || ruleLower.includes('sma')) && (ruleLower.includes('>') || ruleLower.includes('<'))) {
          ...
          return (
            <div key={idx} className="space-y-2">
              <div className="text-sm font-mono text-muted-foreground">{rule}</div>
              <svg viewBox="0 0 400 120" className="w-full h-32">
                <path d="M 0 70 Q 100 65 200 70 Q 300 73 400 75" stroke="#f97316" strokeWidth="2" fill="none" opacity="0.7" />
                <path d={above ? 
                        "M 0 50 L 50 55 L 100 45 L 150 50 L 200 40 L 250 45 L 300 50 L 350 48 L 400 52" : 
          ...
          return (
            <div key={idx} className="space-y-2">
              ...
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                {isOverbought && <path d="M 0 60 Q 100 50 200 15 Q 300 8 400 10" stroke="#3b82f6" strokeWidth="2" fill="none" />}
                {isOversold && <path d="M 0 60 Q 100 70 200 105 Q 300 112 400 110" stroke="#3b82f6" strokeWidth="2" fill="none" />}
        ...
        if (ruleLower.includes('bollinger')) {
          ...
          return (
            <div key={idx} className="space-y-2">
              <div className="text-sm font-mono text-muted-foreground">{rule}</div>
              <svg viewBox="0 0 400 120" className="w-full h-32">
                <path d="M 0 20 Q 100 22 200 20 Q 300 19 400 22" stroke="#f97316" strokeWidth="1" fill="none" opacity="0.5" />
                <path d="M 0 60 Q 100 58 200 60 Q 300 61 400 62" stroke="#f97316" strokeWidth="2" fill="none" opacity="0.7" />
                <path d="M 0 100 Q 100 98 200 100 Q 300 101 400 102" stroke="#f97316" strokeWidth="1" fill="none" opacity="0.5" />
                {touchesLower && (
                  <>
                    <path d="M 0 60 Q 100 80 200 100 L 250 98 L 300 70 Q 350 65 400 60" stroke="#22c55e" strokeWidth="2" fill="none" />
                    <circle cx="200" cy="100" r="6" fill="#22c55e" stroke="white" strokeWidth="2" />
                  </>
                )}
                {touchesUpper && (
                  <>
                    <path d="M 0 60 Q 100 40 200 20 L 250 22 L 300 50 Q 350 55 400 60" stroke="#ef4444" strokeWidth="2" fill="none" />
        ...
        if (ruleLower.includes('volume') && (ruleLower.includes('>') || ruleLower.includes('sma'))) {
          return (
            <div key={idx} className="space-y-2">
              <div className="text-sm font-mono text-muted-foreground">{rule}</div>
              <svg viewBox="0 0 400 120" className="w-full h-32">
                <path d="M 0 70 Q 100 68 200 70 Q 300 71 400 72" stroke="#f97316" strokeWidth="2" fill="none" opacity="0.7" />
          ...
          return (
            <div key={idx} className="space-y-2">
              ...
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                <line x1="0" y1="100" x2="400" y2="100" stroke="#22c55e" strokeWidth="1" strokeDasharray="3,3" opacity="0.5" />
                <line x1="0" y1="60" x2="400" y2="60" stroke="currentColor" strokeWidth="1" strokeOpacity="0.2" />
                {isOverbought && <path d="M 0 60 Q 100 40 200 10 Q 300 3 400 5" stroke="#3b82f6" strokeWidth="2" fill="none" />}
                {isOversold && <path d="M 0 60 Q 100 80 200 110 Q 300 117 400 115" stroke="#3b82f6" strokeWidth="2" fill="none" />}
          ...
          return (
            <div key={idx} className="space-y-2">
              ...
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                {strongTrend && (
                  <>
                    <path d="M 0 95 Q 100 90 200 60 Q 300 40 400 30" stroke="#3b82f6" strokeWidth="2" fill="none" />
          ...
          return (
            <div key={idx} className="space-y-2">
              ...
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                {highVolatility && (
                  <>
                    <path d="M 0 75 Q 100 70 200 40 Q 300 25 400 20" stroke="#f97316" strokeWidth="2" fill="none" />
          ...
          return (
            <div key={idx} className="space-y-2">
              ...
              <svg viewBox="0 0 400 120" className="w-full h-32">
                ...
                <path d={isRising ? "M 0 90 Q 100 80 200 50 Q 300 30 400 20" : "M 0 20 Q 100 40 200 70 Q 300 90 400 100"} 
