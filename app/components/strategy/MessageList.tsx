...
export function MessageList({
  ...
  return (
    <div ref={containerRef} className="relative w-full max-w-3xl mx-auto px-6 pt-8 pb-48">
      ...
      {showScrollButton && (
        <div className="sticky bottom-52 left-0 right-0 flex justify-center pointer-events-none mb-4">
          <Button
            size="icon"
