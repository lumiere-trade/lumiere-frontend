  ...
  return (
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent className="w-[320px] max-w-[75vw] sm:w-[320px] md:w-[340px] lg:w-[360px] xl:w-[360px] 2xl:w-[500px] bg-background border-l border-primary/20 [&>button]:hidden z-[70]">
