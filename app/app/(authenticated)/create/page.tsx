              ...
              <div className="w-full max-w-3xl mx-auto space-y-6">
                ...
                <div className="relative w-full">
                  <textarea
                    ...
                    className="w-full px-6 py-4 pr-16 rounded-2xl border border-primary/20 bg-white text-foreground placeholder:text-muted-foreground resize-none focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all shadow-md text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <Button
                    size="icon"
                    onClick={handleSend}
